...
public class SumJob {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "SumJob"); // Job 이름 설정
		...
		job.setJarByClass(SumJob.class); // jar 파일 내용 중 실행할 클래스 이름 지정
		job.setMapperClass(SumMapper.class); // mapper 클래스 지정
		job.setReducerClass(SumReducer.class); // reducer 클래스 지정
		...
		job.setOutputValueClass(DoubleWritable.class); // value의 자료형 지정
