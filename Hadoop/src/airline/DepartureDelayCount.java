...
public class DepartureDelayCount {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "DepartureDelayCount"); // Job 이름 설정
		...
		job.setJarByClass(DepartureDelayCount.class); // jar 파일 내용 중 실행할 클래스 이름 지정
		job.setMapperClass(DepartureDelayCountMapper.class); // mapper 클래스 지정
		job.setReducerClass(DelayCountReducer.class); // reducer 클래스 지정
